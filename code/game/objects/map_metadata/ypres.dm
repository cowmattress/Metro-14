...
//	min_autobalance_players = 90
	...
	roundend_condition_sides = list(
		list(BRITISH) = /area/complex/british/land/inside/objective,
		list(FRENCH) = /area/complex/french/land/inside/objective,
	...
	spawn(2)
		if (faction1 == FRENCH)
			...
			for (var/turf/floor/trench/A1 in world)
				...
				if (istype(A,/area/complex/british/land/inside/objective))
					new/area/complex/french/land/inside/objective(get_turf(A1))
				else if (istype(A,/area/complex/british/land/inside))
					new/area/complex/french/land/inside(get_turf(A1))
				else if (istype(A,/area/complex/british/land/outside))
					new/area/complex/french/land/outside(get_turf(A1))
				else if (istype(A,/area/complex/british/land/outside/objective))
					new/area/complex/french/land/outside/objective(get_turf(A1))
